# @emiplegiaqmnpm/quis-possimus-similique

[![npm](https://img.shields.io/npm/v/@emiplegiaqmnpm/quis-possimus-similique.svg)](https://npmjs.com/package/@emiplegiaqmnpm/quis-possimus-similique)

A JavaScript ANSI color/style management. ANSI parsing. ANSI to CSS. Small, clean, no dependencies.

```bash
npm install @emiplegiaqmnpm/quis-possimus-similique
```
...
```javascript
require ('@emiplegiaqmnpm/quis-possimus-similique').nice // .nice for unsafe String extensions
...
```javascript
import { green, inverse, bgLightCyan, underline, dim } from '@emiplegiaqmnpm/quis-possimus-similique'
```
```javascript
const { green, inverse, bgLightCyan, underline, dim } = require ('@emiplegiaqmnpm/quis-possimus-similique')
```
...
```javascript
import { @emiplegiaqmnpm/quis-possimus-similique, ParsedSpan } from '@emiplegiaqmnpm/quis-possimus-similique' // along with type definitions
```
```javascript
import @emiplegiaqmnpm/quis-possimus-similique from '@emiplegiaqmnpm/quis-possimus-similique'
```

### Nice Mode (not recommended)

```javascript
const ansi = require ('@emiplegiaqmnpm/quis-possimus-similique').nice
```

The `('@emiplegiaqmnpm/quis-possimus-similique').nice` export defines styling APIs on the `String` prototype directly. It uses an ad-hoc DSL (sort of) for infix-style string coloring. The `nice` is convenient, but not safe, avoid using it in public modules, as it alters global objects, and that might cause potential hard-to-debug compatibility issues.
...
```javascript
const { names } = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
```javascript
const { strip } = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
```javascript
const { isEscaped, green } = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
```javascript
const { parse } = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
```javascript
const ansi = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
```javascript
const { bgGreen, red, parse } = require ('@emiplegiaqmnpm/quis-possimus-similique')
...
## Projects That Use `@emiplegiaqmnpm/quis-possimus-similique`
